...
export default function ChartStudio() {
  ...
  const css = `
    ...
    .cs-wl{width:236px;flex:0 0 236px;background:${C.panel};border:1px solid ${C.line};border-radius:12px;padding:8px;align-self:flex-start;max-height:80vh;overflow-y:auto}
    ...
    @media(max-width:900px){.cs-wl{display:none}}
  ...
  return (
    <div style={{ background: C.bg, color: C.text, fontFamily: SANS, padding: 16, borderRadius: 14, maxWidth: (layout === 1 ? 920 : 1340) + (showWl ? 260 : 0), margin: "0 auto", userSelect: "none", WebkitUserSelect: "none" }}>
